...
namespace DentaEquip.BL.ValidationAttributes.SubCategory
{
    public class UniqueSubCategoryName:ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (context.SubCategories.FirstOrDefault(s => s.Name.Equals(newname)) is not null)
            {
